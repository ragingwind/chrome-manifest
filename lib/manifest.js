...
Manifest.prototype.merge = function(src) {
  _.merge(this.manifest, src);
}

module.exports = Manifest;
module.exports.queryPermissions = Metadata.queryPermissions
module.exports.queryManifest = Metadata.queryPermissions
module.exports.getManifest= function(opts) {
  var manifest = Metadata.getManifest(opts);
